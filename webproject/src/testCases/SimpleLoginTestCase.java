...
public class SimpleLoginTestCase {
  ...
  @Test
  public void testSimpleLoginTestCase() throws Exception {
    ...
    driver.findElement(By.xpath("//form[@action='/webproject/SimpleLogin']")).click();
