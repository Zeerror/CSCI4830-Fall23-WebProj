...
public class PasswordValidationTestCase {
  ...
  @Test
  public void testPasswordValidationTestCase() throws Exception {
    ...
    driver.findElement(By.id("newPassword")).sendKeys("correct.");
    driver.findElement(By.id("confirmPassword")).click();
    driver.findElement(By.id("confirmPassword")).clear();
    driver.findElement(By.id("confirmPassword")).sendKeys("incorrect.");
    driver.findElement(By.xpath("//input[@value='Create Account']")).click();
    driver.get("http://localhost:8080/webproject/CreateAccount");
  }
